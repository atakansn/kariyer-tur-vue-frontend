            ...
            <div class="container mx-auto">
                <div class="grid grid-cols-12 lg:gap-10">
                    <div class="col-span-12 xl:col-span-4">
                        <div class="mr-12">
                            <h4 class="text-white mb-6 text-[23px]">Kariyer Tur</h4>
                            <p class="text-white/50 dark:text-gray-300">
                                Geleceğinize Yolculukta Yenilik ve Başarıyla Adım Atın!
                            </p>
                            <p class="mt-3 text-white dark:text-gray-50">Bizi Takip Edin:</p>
                            <div class="mt-5">
                                <ul class="flex gap-3">
            ...
            <div class="container mx-auto">
                <div class="text-center">
                    <p class="mb-0 text-center text-white/50">
                       {{ year }} © Kariyer Tur - İş İlanları Sayfası
                    </p>
                </div>
            </div>
        </section>
