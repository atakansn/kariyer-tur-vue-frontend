...
import ProfileSidebarVerticalMenu from "@/components/ProfileSidebarVerticalMenu.vue";
</script>
...
<template>
    <div class="border rounded border-gray-100/50 dark:border-neutral-600">
        ...
        <div class="p-5 pt-0 border-b border-gray-100/50 dark:border-neutral-600">
                    ...
                    <li v-if="index <= 1">
                        <div class="flex items-center mt-4 ">
                            ...
                            <div class="ml-auto text-xl">
                                <a href="/src/assets/images/dark-logo.png" download="" class="text-gray-500 fs-20"><i
